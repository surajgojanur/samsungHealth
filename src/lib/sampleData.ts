  ...
  return {
    ...
    report: {
      ...
      detections: [
        ...
        { category: "nutrition", label: "Nutrition", status: "Partially available", fileCount: 0, rowCount: 0, confidence: "medium", notes: "Limited in sample." },
        { category: "water", label: "Water", status: "Partially available", fileCount: 0, rowCount: 0, confidence: "medium", notes: "Limited in sample." },
        { category: "stress", label: "Stress/recovery", status: "Partially available", fileCount: 0, rowCount: 0, confidence: "medium", notes: "Experimental." },
        { category: "bloodPressure", label: "Blood pressure", status: "Missing", fileCount: 0, rowCount: 0, confidence: "high", notes: "Not found in this export." },
        { category: "ecg", label: "ECG", status: "Missing", fileCount: 0, rowCount: 0, confidence: "high", notes: "Not found in this export." },
        { category: "menstrualCycle", label: "Menstrual cycle", status: "Missing", fileCount: 0, rowCount: 0, confidence: "high", notes: "Not found in this export." },
        { category: "metadata", label: "Device/source metadata", status: "Available", fileCount: 1, rowCount: data.metadata.length, confidence: "medium", notes: "Masked source metadata." },
